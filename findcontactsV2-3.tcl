...
proc FC-receptor-ligand {__OUTPUT_FILE__ __RECEPTOR__ __LIGAND__ __MIN_FREQ__} {
    ...
    for {set __FRAME__ $__FRAME_INITIAL__} {$__FRAME__ < $__FRAME_TOTAL__} {incr __FRAME__} {
        ...
        if { [expr {"$__RECEPTOR_LIGAND_TYPE_CODE__" eq "1010"}] } {
            ...
            lassign [measure contacts 5.0 [atomselect top "$__RECEPTOR__ and $__PROTEIN_HYDROPHOBIC__" frame $__FRAME__] [atomselect top "$__LIGAND__ and $__PROTEIN_HYDROPHOBIC__" frame $__FRAME__]] __HYDROPHOBIC_LIST_ATOMS_1__ __HYDROPHOBIC_LIST_ATOMS_2__
            #
